...
import 'package:test_ap1/ui/pages/feeding_page/supplementation.dart';
...
class _CardWidgetState extends ConsumerState<_CardWidget> {
  @override
  void initState() {
    ref.read(feedingAndVerificationPageProvider).initNFC(ref, Navigator.of(context), const Supplementation());
    super.initState();
  }
...
class _ScanWidgetState extends ConsumerState<_ScanWidget> {
  ...
  final GlobalKey qrFeedingKey = GlobalKey(debugLabel: 'qrFeeding');
